...
namespace TravelAgentApp.Migrations
{
    ...
    [Migration("20231018100959_initial")]
            ...
            modelBuilder.Entity("TravelAgentApp.Models.Inventory", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            EndValidDate = new DateTime(2023, 10, 19, 0, 0, 0, 0, DateTimeKind.Local),
                            InventoryDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            InventoryNo = "INV00001",
                            ProductId = 1,
                            Qty = 1,
                            StartValidDate = new DateTime(2023, 10, 18, 0, 0, 0, 0, DateTimeKind.Local),
                            UpdatedBy = ""
                        });
                });
            ...
            modelBuilder.Entity("TravelAgentApp.Models.Merchant", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2023, 10, 18, 17, 9, 59, 4, DateTimeKind.Local).AddTicks(1538),
            ...
            modelBuilder.Entity("TravelAgentApp.Models.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedOn = new DateTime(2023, 10, 18, 17, 9, 59, 4, DateTimeKind.Local).AddTicks(1762),
